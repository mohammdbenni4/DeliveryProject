...
namespace Persistence.Migrations
{
    ...
    [Migration("20240107183804_FixDriver")]
    partial class FixDriver
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Driver", b =>
                {
                    ...
                    b.Property<List<string>>("MobileNumbers")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<Dictionary<TimeOnly, TimeOnly>>>("Times")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Domain.Models.Product", b =>
                {
                    ...
                    b.Property<IReadOnlyCollection<ProductAddOne>>("AddOnes")
                        .IsRequired()
                        .HasColumnType("jsonb");
